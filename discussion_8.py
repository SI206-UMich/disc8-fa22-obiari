...
def getLink(soup):
    olympics = soup.find("a", title = "List of universities with Olympic medal wins" )
...
def getAdmissionsInfo2019(soup):
    ...
    soup = BeautifulSoup(resp.content, 'html.oarser')
    tag = soup.find('td', class_ = 'College/school founding')
    print(tag.text)
